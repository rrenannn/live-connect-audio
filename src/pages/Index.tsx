...
const Index = () => {
  const {
    connectionStatus, callStatus, callMode, activeRoomId, logs,
    remoteStreams, localVideoRef, incomingCall,
    connect, disconnect, startCall, joinCall, acceptCall, rejectCall
  } = useWebRTC();
